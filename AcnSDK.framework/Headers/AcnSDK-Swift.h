...
SWIFT_MODULE_NAMESPACE_PUSH("AcnSDK")

SWIFT_CLASS("_TtC6AcnSDK15ArrowConnectIot")
@interface ArrowConnectIot : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end

@class NSCoder;

SWIFT_CLASS("_TtC6AcnSDK9AwsConfig")
...
SWIFT_CLASS("_TtC6AcnSDK11AzureConfig")
@interface AzureConfig : NSObject <NSCoding>
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC6AcnSDK9CocoaMQTT")
...
/// MQTT Message
SWIFT_CLASS("_TtC6AcnSDK16CocoaMQTTMessage")
...
/// MQTT Will Message
SWIFT_CLASS("_TtC6AcnSDK13CocoaMQTTWill")
@interface CocoaMQTTWill : CocoaMQTTMessage
@end


SWIFT_CLASS("_TtC6AcnSDK21GatewayConfigResponse")
@interface GatewayConfigResponse : NSObject <NSCoding>
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC6AcnSDK9IbmConfig")
@interface IbmConfig : NSObject <NSCoding>
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC6AcnSDK16IotConnectConfig")
@interface IotConnectConfig : NSObject <NSCoding>
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC6AcnSDK16IotDataPublisher")
@interface IotDataPublisher : NSObject <EDQueueDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (void)queue:(EDQueue * _Null_unspecified)queue processJob:(NSDictionary * _Null_unspecified)job completion:(EDQueueCompletionBlock _Null_unspecified)block;
@end
...
SWIFT_CLASS("_TtC6AcnSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(AcnSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AcnSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AcnSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AcnSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(AcnSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC6AcnSDK12TaskDelegate")
